...
class FileProcessor:
    ...
    def write_file(file_name, table):
        """Function to manage data writing from a list of dictionaries to a file

        Reads data from a 2D table (list of dicts) and appends one line at a time to a file.
